        ...
        <footer class="py-2 px-5 bg-dark sticky-bottom">
            <div className="row">
                ...
                <ul className="social-network social-circle ml-auto">
                    <li><a href="https://www.linkedin.com/in/jarrodbataille/" target="_blank" rel="noopener noreferrer" className="icoLinkedin" title="Linkedin"><i className="fa fa-linkedin"></i></a></li>
